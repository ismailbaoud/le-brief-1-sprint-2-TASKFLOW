...
function affichage(taches) {
  ...
  taches.forEach((tach) => {
    ...
    `<div id="div"  class="bg-gray-100 rounded-lg text-center m-3 mb-5 w-auto break-words" data-id="${tach.id} ">
            ...
            <button id='${tach.id}' onclick="handle(${tach.id})" type="button" class="break-word sw-auto max-w-full ml-3"><p id="descrip-${tach.id}" class="font-normal font-mono text-left line-clamp-2"> ${tach.description}</p></button>
